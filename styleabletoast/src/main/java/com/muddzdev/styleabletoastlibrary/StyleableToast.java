...
/**
 * StyleableToast is a very easy and quick way to style your toast and gives them an unique style and feeling compared to the default boring grey ones. StyleableToast have 10 styling options. <p>If a
 * particular style option is not set, the option will fall back to the standard Android Toast style</p>
 */
...
public class StyleableToast implements OnToastFinished {
	 ...
	 *                  android:radius.
	 *              Corner radius<br> android:alpha. Value between 1-255 where 255 is full solid<br> android:icon.<br>
	 */
	...
	/**
	 * A callback that automatically cancels and resets animations when the toast is finished showing on screen. Users should not call this method.
	 */
	@Override
